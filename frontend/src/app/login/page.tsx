...
export default function LoginPage() {
  ...
  const handleEmailLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Placeholder — backend email auth not implemented yet
    ...
    <div className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="w-full max-w-[380px] border border-gray-200 rounded-2xl p-8">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 py-2.5 rounded-lg border border-gray-200 bg-gray-50 text-sm font-medium text-gray-700 hover:bg-gray-100 transition-colors mb-4 cursor-pointer"
        >
        ...
        <form onSubmit={handleEmailLogin}>
          ...
          <button
            type="submit"
            className="w-full py-2.5 rounded-lg bg-[#10B981] text-white text-sm font-medium hover:bg-[#059669] transition-colors cursor-pointer"
          >
            Login
          </button>
        </form>
